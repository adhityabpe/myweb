<?php 
add_action( 'wp_enqueue_scripts', 'colorful_newsly_enqueue_styles' );
function colorful_newsly_enqueue_styles() {
	wp_enqueue_style( 'parent-style', get_template_directory_uri() . '/style.css' ); 

} 

function colorful_newsly_google_fonts() {
	wp_enqueue_style( 'fluic-basics-google-fonts', '//fonts.googleapis.com/css?family=Playfair+Display:wght@500&family=Poppins:ital,wght@0,400;0,600;1,400;1,600&display=swap', false ); 
}
add_action( 'wp_enqueue_scripts', 'colorful_newsly_google_fonts' );


add_theme_support( 'custom-background', apply_filters( 'responsiveblogily_custom_background_args', array(
	'default-color' => '#f9e5db',
) ) );

function colorful_newsly_customize_register( $wp_customize ) {

	$wp_customize->add_section( 'showhide_sidebar', array(
		'title'      => __('Show/hide Sidebar','colorful-newsly'),
		'priority'   => 1,
	...
	$wp_customize->add_setting( 'sidebar_hide', array(
		'default' => 0,
		'sanitize_callback' => 'colorful_newsly_sanitize_checkbox',
	) );
	$wp_customize->add_control( 'sidebar_hide', array(
		'label'    => __( 'Hide Sidebar', 'colorful-newsly' ),
	...
	$wp_customize->add_section( 'navigation_settings', array(
		'title'      => __('Navigation Settings','colorful-newsly'),
		'priority'   => 1,
		'capability' => 'edit_theme_options',
	) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'navigation_background_color', array(
		'label'       => __( 'Background Color', 'colorful-newsly' ),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'navigation_text_color', array(
		'label'       => __( 'Link Color', 'colorful-newsly' ),
		'section'     => 'navigation_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'navigation_border_color', array(
		'label'       => __( 'Border Color', 'colorful-newsly' ),
		'section'     => 'navigation_settings',
		'priority'   => 1,
...
add_action( 'customize_register', 'colorful_newsly_customize_register' );

if(! function_exists('colorful_newsly_customizer_css_final_output' ) ):
	function colorful_newsly_customizer_css_final_output(){
		?>
	...
	<?php }
	add_action( 'wp_head', 'colorful_newsly_customizer_css_final_output' );
endif;


function colorful_newsly_sanitize_checkbox( $input ) {
