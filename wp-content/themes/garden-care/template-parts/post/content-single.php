    ...
    <div class="article_content">
      <div class="article-text">
        ...
        <div class="metabox1"> 
          ...
          <span class="entry-comments"><i class="fas fa-comments"></i><?php comments_number( __('0 Comments','garden-care'), __('0 Comments','garden-care'), __('% Comments','garden-care') ); ?></span>
        </div>
